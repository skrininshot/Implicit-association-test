namespace Models
{
    public class IatResultsModel : IQuestionnaireResultsModel
    {
        ...
        public IatResultsModel(double dScore, double avgLatencyDiff, double accuracyPhase0, double accuracyPhase1, string interpretation)
        {
            DScore = dScore;
